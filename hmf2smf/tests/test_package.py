...
def test_snrate():
    assert snrate('SALPETER') == pytest.approx(0.007421779932978433)
...
def test_stellarmass_func():
    ...
    assert stellarmass_func(test_HMF,5,test_cosmo) == pytest.approx(np.array([7.87528126e+06, 7.87528126e+10, 7.87528126e+14]),rel=1e-8)
